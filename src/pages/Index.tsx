    ...
    <Layout>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full min-h-[100vh] px-4 sm:px-6 py-20 pointer-events-none">
          ...
          <div className="flex flex-col items-center justify-center text-center max-w-5xl mx-auto space-y-6 sm:space-y-8 pointer-events-auto">
            ...
            >
              <Link
                to="/contact"
                className="font-body w-full sm:w-auto px-8 py-3.5 sm:py-4 rounded-full bg-white text-[#0A1628] font-bold tracking-wide shadow-[0_0_30px_rgba(255,255,255,0.2)] hover:shadow-[0_0_40px_rgba(255,255,255,0.4)] transition-all duration-300 hover:scale-105 text-center flex items-center justify-center"
              >
                Register Now
              </Link>
              <button
                onClick={() => document.getElementById("timeline")?.scrollIntoView({ behavior: "smooth" })}
                className="font-body w-full sm:w-auto px-8 py-3.5 sm:py-4 rounded-full border border-white/20 bg-white/5 backdrop-blur-md text-white font-medium hover:bg-white/10 hover:border-white/40 transition-all duration-300 text-center flex items-center justify-center"
              >
                Explore Events
              </button>
            </div>
      ...
      <section className="page-container px-4 sm:px-6 w-full">
        ...
        <div className="relative w-full mt-2 sm:mt-6 py-4">
          ...
          <p className="font-body relative z-10 text-muted-foreground text-base sm:text-lg md:text-xl leading-relaxed max-w-4xl mx-auto text-center px-2">
